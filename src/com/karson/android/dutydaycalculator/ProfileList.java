...
public class ProfileList {
	...
	public void resetWithDefault(Context context) {
		...
		// C-17 basic profile
		ProfileClass profile = new ProfileClass("C-17 Basic");
		profile.addRow("Stop Drinking", false, 8, 15);
		profile.addRow("Report", true, 1, 0);
		profile.addRow("Airland Takeoff", true, 3, 45);
		profile.addRow("Airdrop Takeoff", true, 4, 15);
		...
		// C-17 augmented profile
		profile = new ProfileClass("C-17 Augmented");
		profile.addRow("Stop Drinking", false, 8, 15);
		profile.addRow("Report", true, 1, 0);
		profile.addRow("Airland Takeoff", true, 3, 45);
		profile.addRow("Airdrop Takeoff", true, 4, 15);
		...
		profile.addRow("Stop Drinking", false, 8, 45);
		profile.addRow("Report", true, 1, 0);
		...
		profile.addRow("Stop Drinking", false, 9, 0);
		profile.addRow("Report", true, 1, 0);
		...
		profile.addRow("Stop Drinking", false, 11, 0);
		profile.addRow("Report", true, 1, 0);
		profile.addRow("FDP with inop AP", true, 13, 0);
		profile.addRow("AAR", true, 15, 0);
		profile.addRow("Tactical Duty Day", true, 15, 0);
		...
		profile.addRow("Stop Drinking", false, 7, 45);
		profile.addRow("Report", true, 1, 0);
